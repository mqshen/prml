在第一章中，我们强调了概率论在模式识别中的核心作用。现在我们探索一些概率分布及他们的重要作用。这些概率分布本身就很有趣。这些分布可以组成更复杂的模型，且在本书中广泛的使用。本章中介绍的分布还有一个重要的目的，即让我们有机会在简单的模型中讨论一些关键的统计学概念，如贝叶斯推断。在后续章节中会在更复杂的模型里遇到这些简单的模型。    
